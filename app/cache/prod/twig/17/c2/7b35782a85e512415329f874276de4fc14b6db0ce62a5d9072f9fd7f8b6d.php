...
class __TwigTemplate_17c27b35782a85e512415329f874276de4fc14b6db0ce62a5d9072f9fd7f8b6d extends Twig_Template
{
    ...
    <li>
        <a href=\"";
        // line 82
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("ens_job_edit", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : null), "id", array()))), "html", null, true);
        echo "\">
            Edit
        </a>
    </li>

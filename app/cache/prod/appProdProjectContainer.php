...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '192.168.106.129', 'port' => NULL, 'dbname' => 'jobeet', 'user' => 'anton1', 'password' => '16051987anton', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ef5f036dfb10390fc60fe25b05ce36e531c0b42f287206c393cd09f467a52253');
        return $instance;
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $instance->setHost('192.168.106.129');
        $instance->setPort(25);
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('d126c7723a17f96d7414d0047348bb2ca390fdb6');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_host' => '192.168.106.129',
            'database_port' => NULL,
            'database_name' => 'jobeet',
            'database_user' => 'anton1',
            'database_password' => '16051987anton',
            'mailer_transport' => 'smtp',
            'mailer_host' => '192.168.106.129',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'en',
            'secret' => 'd126c7723a17f96d7414d0047348bb2ca390fdb6',
            ...
            'kernel.secret' => 'd126c7723a17f96d7414d0047348bb2ca390fdb6',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => '192.168.106.129',
